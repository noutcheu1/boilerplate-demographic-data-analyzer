...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = pd.read_csv('/home/noutcheu/boilerplate-demographic-data-analyzer/adult.data.csv')
    ...
    highest_earning_country_ = df[df['salary']=='>50K']['native-country'].value_counts()
    country_earning =  round( highest_earning_country_ / df['native-country'].value_counts() * 100, 1)
    highest_earning_country =  country_earning.idxmax()
    highest_earning_country_percentage = round(country_earning[highest_earning_country], 1)
